...
class UncontrolledAgent:
    def __init__(self, init_state, dt=0.2, T=20, H=12, min_action_duration=10.0, num_switches=1, action_variance=0.01):
    ...
    def get_gmm_predictions_from_current(self, current_state):
        ...
        for agent_id in range(self.num_agents):
            ...
            for mode, (v, omega) in enumerate(self.actions):
                # Initial state
                x ,y, theta = current_state[agent_id][0], current_state[agent_id][1], current_state[agent_id][2]
